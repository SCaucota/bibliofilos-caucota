...
import { backdropClasses, FormControlLabel, Radio, RadioGroup, TextField } from '@mui/material';
...
const Checkout = () => {
  ...
  const {cart, emptyCart, total, setQuantityTotal, formatPrice} = useContext(CartContext);
            ...
            cart.map(product => (
              ...
              <form className='formCheckout' action="" onSubmit={manageForm}>
                ...
                <div className='personalDataContainer'>
                  <TextField onChange={(e) => setName(e.target.value)} id="outlined-basic" label="Nombre" variant="outlined" />
                  <TextField onChange={(e) => setLastname(e.target.value)} id="outlined-basic" label="Apellido" variant="outlined" />
                  <TextField onChange={(e) => setEmail(e.target.value)} id="outlined-basic" label="Email" variant="outlined" />
                  <TextField onChange={(e) => setRepeatEmail(e.target.value)} id="outlined-basic" label="Repetir Email" variant="outlined" />
                  <TextField onChange={(e) => setAddress(e.target.value)} id="outlined-basic" label="Dirección" variant="outlined" />
                  <TextField onChange={(e) => setPhoneNumber(e.target.value)} id="outlined-basic" label="Teléfono" variant="outlined" />
                </div>
                <h2>Datos de Tarjeta</h2>
                <div className='personalDataContainer'>
                  <TextField onChange={(e) => setCardNumber(e.target.value)} id="outlined-basic" label="Número de Tarjeta" variant="outlined" />
                  <TextField onChange={(e) => setCardOwner(e.target.value)} id="outlined-basic" label="Titular" variant="outlined" />
                </div>
                {
                ...
                <div className='buttonsFormContainer'>
                  <Button btnError={'buttonError'} btnText={'Cancelar'} action={() => cancelPurchase()}/>
